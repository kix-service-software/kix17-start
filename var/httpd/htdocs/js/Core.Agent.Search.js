    ...
    TargetNS.OpenSearchDialog = function (Action, Profile, EmptySearch) {
        ...
        Core.AJAX.FunctionCall(
            ...
            function (HTML) {
                ...
                $('#SearchProfileVirtualQueueBlock').hide();
                ...
                if (
                    ...
                    if ($('#SearchProfile').val().match(Regexp)) {
                        ...
                        $('#ShowProfileAsQueue').attr('disabled', 'disabled');
                    }

                    // show add to category block
                    // only show add to category block if search profile is not subscribed
                    if ($('#SearchProfile').val().match(Regexp)) {
