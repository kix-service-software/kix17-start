                    ...
                    Update: function () {
                        ...
                        $('.CanDrag').each(
                            function () {
                                ...
                                if ( $('#Core_UI_AutogeneratedID_0').length ) {
                                    url += ';CustomerID='
                                        + $('#Core_UI_AutogeneratedID_0').find('input[name=CustomerID]').val()
                                        + ';CustomerLogin='
                                        + $('#Core_UI_AutogeneratedID_0').find('input[name=CustomerLogin]').val();
                                }
                            }
                        );
