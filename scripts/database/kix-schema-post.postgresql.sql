...
ALTER TABLE faq_category ADD CONSTRAINT FK_faq_category_valid_id_id FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE faq_item ADD CONSTRAINT FK_faq_item_valid_id_id FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE general_catalog ADD CONSTRAINT FK_general_catalog_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE general_catalog ADD CONSTRAINT FK_general_catalog_change_by_id FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE general_catalog_preferences ADD CONSTRAINT FK_general_catalog_preferences_general_catalog_id_id FOREIGN KEY (general_catalog_id) REFERENCES general_catalog (id);
ALTER TABLE imexport_template ADD CONSTRAINT FK_imexport_template_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE imexport_template ADD CONSTRAINT FK_imexport_template_change_by_id FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE cip_allocate ADD CONSTRAINT FK_cip_allocate_priority_id_id FOREIGN KEY (priority_id) REFERENCES ticket_priority (id);
ALTER TABLE cip_allocate ADD CONSTRAINT FK_cip_allocate_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE cip_allocate ADD CONSTRAINT FK_cip_allocate_change_by_id FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE configitem ADD CONSTRAINT FK_configitem_class_id_id FOREIGN KEY (class_id) REFERENCES general_catalog (id);
ALTER TABLE configitem ADD CONSTRAINT FK_configitem_cur_depl_state_id_id FOREIGN KEY (cur_depl_state_id) REFERENCES general_catalog (id);
ALTER TABLE configitem ADD CONSTRAINT FK_configitem_cur_inci_state_id_id FOREIGN KEY (cur_inci_state_id) REFERENCES general_catalog (id);
ALTER TABLE configitem ADD CONSTRAINT FK_configitem_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE configitem ADD CONSTRAINT FK_configitem_change_by_id FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE configitem_definition ADD CONSTRAINT FK_configitem_definition_class_id_id FOREIGN KEY (class_id) REFERENCES general_catalog (id);
ALTER TABLE configitem_definition ADD CONSTRAINT FK_configitem_definition_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE configitem_version ADD CONSTRAINT FK_configitem_version_configitem_id_id FOREIGN KEY (configitem_id) REFERENCES configitem (id);
ALTER TABLE configitem_version ADD CONSTRAINT FK_configitem_version_definition_id_id FOREIGN KEY (definition_id) REFERENCES configitem_definition (id);
ALTER TABLE configitem_version ADD CONSTRAINT FK_configitem_version_depl_state_id_id FOREIGN KEY (depl_state_id) REFERENCES general_catalog (id);
ALTER TABLE configitem_version ADD CONSTRAINT FK_configitem_version_inci_state_id_id FOREIGN KEY (inci_state_id) REFERENCES general_catalog (id);
ALTER TABLE configitem_version ADD CONSTRAINT FK_configitem_version_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE configitem_counter ADD CONSTRAINT FK_configitem_counter_class_id_id FOREIGN KEY (class_id) REFERENCES general_catalog (id);
ALTER TABLE configitem_history_type ADD CONSTRAINT FK_configitem_history_type_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE configitem_history_type ADD CONSTRAINT FK_configitem_history_type_change_by_id FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE configitem_history_type ADD CONSTRAINT FK_configitem_history_type_valid_id_id FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE configitem_history ADD CONSTRAINT FK_configitem_history_configitem_id_id FOREIGN KEY (configitem_id) REFERENCES configitem (id);
ALTER TABLE configitem_history ADD CONSTRAINT FK_configitem_history_type_id_id FOREIGN KEY (type_id) REFERENCES configitem_history_type (id);
ALTER TABLE configitem_history ADD CONSTRAINT FK_configitem_history_create_by_id FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE attachment_dir_preferences ADD CONSTRAINT FK_attachment_dir_preferences_attachment_directory_id_id FOREIGN KEY (attachment_directory_id) REFERENCES attachment_directory (id);
ALTER TABLE kix_dep_dynamic_field_prefs ADD CONSTRAINT FK_kix_dep_dynamic_field_prefs_dependingfield_id_id FOREIGN KEY (dependingfield_id) REFERENCES kix_dep_dynamic_field (id);
ALTER TABLE kix_text_module_object_link ADD CONSTRAINT FK_kix_text_module_object_link_text_module_id_id FOREIGN KEY (text_module_id) REFERENCES kix_text_module (id);
ALTER TABLE kix_ticket_notes ADD CONSTRAINT FK_kix_ticket_notes_ticket_id_id FOREIGN KEY (ticket_id) REFERENCES ticket (id);
ALTER TABLE kix_ticket_template_prefs ADD CONSTRAINT FK_kix_ticket_template_prefs_template_id_id FOREIGN KEY (template_id) REFERENCES kix_ticket_template (id);
