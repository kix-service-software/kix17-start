# --
# ImportExportObjectService2CustomerUser.t - all import export tests for the Service2CustomerUser object backend
...
# check object list
$Self->True(
    $ObjectList1 && ref $ObjectList1 eq 'HASH' && $ObjectList1->{Service2CustomerUser},
    "Test $TestCount: ObjectList() - Service2CustomerUser exists",
);
