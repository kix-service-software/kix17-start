...
my $StartTime;
my $TestCaseDir  = $ConfigObject->Get('Home') . '/scripts/test/GenericInterface/Operation/Ticket/TicketCreate';
...
$StartTime           = $Self->GetMilliTimeStamp();
my $OperationModule  = 'Kernel::GenericInterface::Operation::Ticket::TicketCreate';
...
for my $File ( @FilesInDirectory ) {
    ...
    $Self->TestCaseStart(
        TestCase    => 'File: ' . $File,
        Feature     => 'Kernel::GenericInterface::Operation::Ticket::TicketCreate',
        Story       => 'GenericInterface Operation Ticket::TicketCreate',
        Description => 'Check return data of GenericInterface Operation Ticket::TicketCreate'
    );
