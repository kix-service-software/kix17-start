...
#    $Self->{SessionModule} = 'Kernel::System::AuthSession::FS';
    ...
    # turn off the CheckRemoteID. ) [1|0]
...
#    $Self->{'MIME-Viewer'}->{'text/xml'} = $Self->{Home}.'/scripts/tools/xml2html.pl';
    ...
    $Self->{'Loader::Customer::CommonCSS'}->{'000-Framework'} =  [
        ...
        'thirdparty/jstree-3.3.16/themes/default/style.min.css',
        'Base.ColorTheme.css',
        'Base.css',
        'Base.Header.css',
        'Base.Footer.css',
    ...
    $Self->{'Loader::Customer::CommonJS'}->{'000-Framework'} =  [
        ...
        'thirdparty/jstree-3.3.16/jstree.min.js',
    ...
    $Self->{'Loader::Agent::CommonJS'}->{'000-Framework'} =  [
        ...
        'thirdparty/jstree-3.3.16/jstree.min.js',
        'thirdparty/jquery-tablesorter-2.31.3/jquery.tablesorter.min.js',
        'thirdparty/jscolor-2.5.2/jscolor.min.js',
        'Core.JavaScriptEnhancements.js',
        'Core.Debug.js',
        'Core.Exception.js',
        'Core.Data.js',
