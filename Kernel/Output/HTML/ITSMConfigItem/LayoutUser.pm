# --
# Kernel/Output/HTML/ITSMConfigItemLayoutUser.pm - layout backend module
...
Kernel::Output::HTML::ITSMConfigItemLayoutUser - layout backend module
...
create an object
    ...
    my $BackendObject = $Kernel::OM->Get('Kernel::Output::HTML::ITSMConfigItemLayoutUser');
...
sub InputCreate {
    ...
    my $StringOption = '';
    my $StringSelect = '';
    my $Class        = 'W50pc AgentUserSearch';
    my $Search       = '';
        ...
        && $AutoCompleteConfig->{Active} )
    {
        ...
        $Self->{LayoutObject}->Block(
            Name => 'AgentUserSearchAutoComplete',
            Data => {
