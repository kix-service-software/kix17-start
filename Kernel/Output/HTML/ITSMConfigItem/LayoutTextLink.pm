# --
# Kernel/Output/HTML/ITSMConfigItemLayoutTextLink.pm - layout backend module
...
create an object
    ...
    my $BackendObject = $Kernel::OM->Get('Kernel::Output::HTML::ITSMConfigItemLayoutTextLink');
...
sub OutputStringCreate {
    ...
    $Param{Value} =
        ...
        . $Link
        . '" title="'
        . $Self->{LanguageObject}->Translate( "Open link in new window" )
        . '" target="_blank">'
        . $Param{Value} . '</a>';
