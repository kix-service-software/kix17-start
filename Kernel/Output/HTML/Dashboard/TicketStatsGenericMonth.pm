# --
# based upon DashboardTicketStatsGeneric.pm
...
package Kernel::Output::HTML::Dashboard::TicketStatsGenericMonth;
...
sub Run {
    ...
    my $CacheKey = 'TicketStatsMonth' . '-' . $Self->{UserID} . '-' . $Key;
    ...
    my @ChartData = (
        $LayoutObject->{LanguageObject}->Translate('30 Day Stats'),
        \@TicketWeekdays,
