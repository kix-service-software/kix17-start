# --
# Kernel/Modules/KIXSidebarRemoteDBViewAJAXHandler.pm - AJAX support module for KIXSidebarTicket
# based on Kernel/Modules/KIXSidebarTicketSearchAJAXHandler.pm
