...
package Kernel::System::ITSMConfigItem::XML::Type::DummyX;
...
All xml functions of DummyX objects
...
create an object
    ...
    my $XMLTypeDummyBackendObject = $Kernel::OM->Get('Kernel::System::ITSMConfigItem::XML::Type::DummyX');
