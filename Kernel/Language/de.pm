...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Sorry, Apache::Reload is needed as PerlModule and PerlInitHandler in Apache config file. See also scripts/apache2-httpd.include.conf. Alternatively, you can use the command line tool bin/kix.Console.pl to install packages!' =>
            'Entschuldigung, Apache::Reload wird als Perl-Modul und PerlInitHandler in der Apache-Konfiguration benötigt (siehe auch scripts/apache2-httpd.include.conf). Alternativ können Sie Pakete auch mithilfe des Kommandozeilen-Tools bin/kix.Console.pl installieren.',
...
',
        ...
        'Basic fulltext index settings. Execute "bin/kix.Console.pl Maint::Ticket::FulltextIndexRebuild" in order to generate a new index.' =>
            'Basis-Einstellungen für den Volltext-Index. Führen Sie "bin/kix.Console.pl Maint::Ticket::FulltextIndexRebuild" aus, um den Index neu zu erstellen.',
        ...
        'Define which columns are shown in the linked tickets widget (LinkObject::ViewMode = "complex"). Note: Only Ticket attributes are allowed for DefaultColumns. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default.' =>
            'Definieren Sie, welche Spalten im verlinkte Tickets-Widget sichtbar sein sollen (LinkObject::ViewMode = "complex"). Hinweis: Nur Ticket-Attribute sind als Standard-Spalten erlaubt. Mögliche Einstellungen: 0 = inaktiv, 1 = verfügbar, 2 = standardmäßig aktiv.',
        ...
        'Defines if backslash should be double quoted for LIKE-statements.' =>
            'Steuert, ob Backslash in LIKE-Statements doppelt gequotet werden sollen',
        ...
        'Defines the valid states for unlocked tickets. To unlock tickets the script "bin/kix.Console.pl Maint::Ticket::UnlockTimeout" can be used.' =>
            '',
        ...
        'If this option is enabled, then data of non verified signatures will be processed from email if they are displayed in AgentTicketZoom.' =>
            'Wenn diese Option aktiviert ist, werden die Daten nicht vertrauenswürdiger Signaturen verarbeitet, wenn Sie beim ersten Aufruf des Artikels in AgentTicketZoom angezeigt werden.',
        ...
        'Makes the session management use html cookies. If html cookies are disabled or if the client browser disabled html cookies, then the system will work as usual and append the session id to the links.' =>
            'Benutzt für das Session-Management HTML-Cookies. Wenn HTML-Cookies deaktiviert sind oder im Browser HTML-Cookies deaktiviert sind, arbeitet das System wie immer und fügt die Session-ID an Links an.',
        'Malay' => 'Malaysisch',
        ...
        'Parameters for the dashboard backend of the new tickets overview of the agent interface. "Limit" is the number of entries shown by default. "Group" is used to restrict the access to the plugin (e. g. Group: admin;group1;group2;). "Default" determines if the plugin is enabled by default or if the user needs to enable it manually. "CacheTTLLocal" is the cache time in minutes for the plugin. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed for DefaultColumns. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. "PreSortDefault" defines the presorting of the list. (Permitted attributes: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" defines the sorting direction of the presorting. (Permitted direction: Down, Up) "UserPreSortActive" activates specific setting options of the PreSort/PreOrder on the dashboard for the user.' =>
            'Parameter für das Dashboard-Backend des neue Tickets-Übersichts-Widgets im Agentenbereich. "Limit" bestimmt die Anzahl der standardmäßig angezeigten Einträge. Über "Group" kann der Zugriff auf das Plugin beschränkt werden (z. B. Group: admin;group1;group2;). "Default" gibt an, ob das Plugin standardmäßig aktiviert sein soll oder ob der Nutzer es manuell aktivieren muss. "CacheTTLLocal" bestimmt die Laufzeit des Plugin-Caches in Minuten. "PreSortDefault" definiert die Vorsortierung der Liste. (Zulässige Attribute: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" definiert die Sortierrichtung der Vorsortierung. (Zulässige Richtung: Down, Up) "UserPreSortActive" aktiviert  spezifische Einstellungsmöglichkeit des PreSort/PreOrder am Dashboard für die Nutzer.',
        'Parameters for the dashboard backend of the open tickets overview of the agent interface. "Limit" is the number of entries shown by default. "Group" is used to restrict the access to the plugin (e. g. Group: admin;group1;group2;). "Default" determines if the plugin is enabled by default or if the user needs to enable it manually. "CacheTTLLocal" is the cache time in minutes for the plugin. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed for DefaultColumns. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. "PreSortDefault" defines the presorting of the list. (Permitted attributes: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" defines the sorting direction of the presorting. (Permitted direction: Down, Up) "UserPreSortActive" activates specific setting options of the PreSort/PreOrder on the dashboard for the user.' =>
            'Parameter für das Dashboard-Backend des offene Tickets-Übersichts-Widgets im Agentenbereich. "Limit" bestimmt die Anzahl der standardmäßig angezeigten Einträge. Über "Group" kann der Zugriff auf das Plugin beschränkt werden (z. B. Group: admin;group1;group2;). "Default" gibt an, ob das Plugin standardmäßig aktiviert sein soll oder ob der Nutzer es manuell aktivieren muss. "CacheTTLLocal" bestimmt die Laufzeit des Plugin-Caches in Minuten. Hinweis: Nur Ticket-Attribute und dynamische Felder (DynamicField_NameX) sind für DefaultColumns erlaubt. Mögliche Einstellungen: 0 = Inaktiv, 1 = Verfügbar, 2 = standardmäßig aktiv. "PreSortDefault" definiert die Vorsortierung der Liste. (Zulässige Attribute: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" definiert die Sortierrichtung der Vorsortierung. (Zulässige Richtung: Down, Up) "UserPreSortActive" aktiviert  spezifische Einstellungsmöglichkeit des PreSort/PreOrder am Dashboard für die Nutzer.',
        ...
        'Parameters for the dashboard backend of the search template tickets overview of the agent interface. "Limit" is the number of entries shown by default. "Group" is used to restrict the access to the plugin (e. g. Group: admin;group1;group2;). "Default" determines if the plugin is enabled by default or if the user needs to enable it manually. "CacheTTLLocal" is the cache time in minutes for the plugin. "PreSortDefault" defines the presorting of the list. (Permitted attributes: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" defines the sorting direction of the presorting. (Permitted direction: Down, Up) "UserPreSortActive" activates specific setting options of the PreSort/PreOrder on the dashboard for the user.' =>
            'Parameter für das Dashboard-Backend des Ticket-Suchvorlagen-Übersichts-Widgets im Agentenbereich. "Limit" bestimmt die Anzahl der standardmäßig angezeigten Einträge. Über "Group" kann der Zugriff auf das Plugin beschränkt werden (z. B. Group: admin;group1;group2;). "Default" gibt an, ob das Plugin standardmäßig aktiviert sein soll oder ob der Nutzer es manuell aktivieren muss. "CacheTTLLocal" bestimmt die Laufzeit des Plugin-Caches in Minuten. "PreSortDefault" definiert die Vorsortierung der Liste. (Zulässige Attribute: State, Type, Owner, Responsible, CustomerID, Lock, Service, SLA) "PreOrderDefault" definiert die Sortierrichtung der Vorsortierung. (Zulässige Richtung: Down, Up) "UserPreSortActive" aktiviert  spezifische Einstellungsmöglichkeit des PreSort/PreOrder am Dashboard für die Nutzer.',
